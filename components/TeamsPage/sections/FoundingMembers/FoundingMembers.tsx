...
const FoundingMembers = () => {
  ...
  useEffect(() => {
    const getFoundingMemberData = async () => {
      const data = await axios.get("/api/teams/foundingMembers")
      setFoundingMemberData([...data.data])
    }
    getFoundingMemberData()
  }, [])
  return (
    <div className="flex flex-col justify-center m-4 lg:md:w-[90%]">
      ...
      <div className="w-full text-sm font-bold lg:md:w-1/2 lg:md:text-xl font-objektivmk1">
        ...
        burned 88 Divine Ancestral Pendants to claim a founding members&apos; pass and they
        represent an integral part of the leading team of the Cre8ors collective.
      </div>
