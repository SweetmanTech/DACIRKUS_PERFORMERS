const FAQCard = () => (
  <div className="w-full h-full grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 p-4 md:p-8 max-md:bg-gray-100">
    <div className="faq-column p-4 md:p-6">
      <div className="faq-content">
        ...
        <p className="text-[12px] text-gray-600 mb-1">
          ...
          owned by purchasing its corresponding NFT. Da Performers serve as the official entry point
          to Da Cirkus!
        </p>

        <h5 className="text-sm font-semibold text-gray-700">2. How much do Da Performers cost?</h5>
        ...
        <p className="text-[12px] text-gray-600 ">
          Each character combination can be created only once. We will continue minting until we run
          out of character combinations or until the team decides to close minting.
        </p>
        ...
        <p className="text-[12px] text-gray-600">
          Yes, you are permitted to use your Da Performer for personal or commercial purposes, such
          as digital avatars, profile pictures, and merchandise, as long as your earnings do not
          exceed $100,000.
        </p>
      </div>
    </div>
    <div className="faq-column p-6">
      <div className="faq-content">
        ...
        <p className="text-[12px] text-gray-600">
          No, Da Performers are digital collectibles intended for entertainment purposes. While they
          may increase in value over time, there is no guaranteed return on investment.
        </p>
