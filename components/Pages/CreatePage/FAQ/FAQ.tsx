  ...
  return (
    <div className="w-full h-full grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 p-4 md:p-8 max-md:bg-gray-100">
      ...
      <div className="faq-column p-6">
        <div className="faq-content">
          <h5 className="text-sm font-semibold text-gray-700">
            6. How do I opt out of sharing my character's intellectual property?
          </h5>
          <p className="text-[12px] text-gray-600">
            If you wish to opt out of sharing your character's intellectual property for use in Da
