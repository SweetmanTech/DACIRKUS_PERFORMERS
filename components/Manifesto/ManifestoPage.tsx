        ...
        <Layout type="contained" hasFooter={false}>
            ...
            ">
                <div className="
                    ...
                    text-[9px] xs:text-[10px] md:text-[19px] dark:text-white 
                    leading-[200%] md:leading-[137%]
                ">
                    ...
                    Cre8ors are advocates. We support each others mental health.<br/>
                    Cre8ors are fearless. We are not afraid to speak our minds. <br/>
                    Cre8ors have empathy. We will walk a mile in any shoe.
                    <br/>
