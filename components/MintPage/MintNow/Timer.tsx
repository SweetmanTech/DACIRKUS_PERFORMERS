  ...
  return (
    <div className="bg-white p-[20px] rounded-[10px]">
      <div className="grid grid-cols-4 gap-x-[30px]">
        <div>
          <div className="font-quicksand font-bold text-[20px] text-center pb-[15px]">DAYS</div>
        ...
        <div>
          <div className="font-quicksand font-bold text-[20px] text-center pb-[15px]">HOURS</div>
          <div className="grid grid-cols-2 gap-x-[10px]">
            <div
              className="text-center text-white text-[102px] font-medium font-quicksand bg-black rounded-[10px]
                  min-w-[101px]"
        ...
        <div>
          <div className="font-quicksand font-bold text-[20px] text-center pb-[15px]">MINUTES</div>
          <div className="grid grid-cols-2 gap-x-[10px]">
            <div
              className="text-center text-white text-[102px] font-medium font-quicksand bg-black rounded-[10px]
                  min-w-[101px]"
        ...
        <div>
          <div className="font-quicksand font-bold text-[20px] text-center pb-[15px]">SECONDS</div>
          <div className="grid grid-cols-2 gap-x-[10px]">
            <div
              className="text-center text-white text-[102px] font-medium font-quicksand bg-black rounded-[10px]
                  min-w-[101px]"
