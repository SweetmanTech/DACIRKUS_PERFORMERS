  ...
  return (
    <div className="flex justify-center w-16 h-6 cursor-pointer">
        <div className={`flex items-center dark:bg-[white] bg-[black] rounded-full w-full h-6 pl-2`} onClick={onClick}>
          <div className={`${isToggle ? styles.toggle_dot : styles.untoggle_dot} dark:bg-[black] bg-[white] w-5 h-5 rounded-full transition duration-[300ms] ease-[cubic-bezier(0.68,-0.55,0.265,1.55)]`}></div> 
        </div>
    </div>
  )
}
